...
class TestCheckoutCLI:
    ...
    def cli_instance(self, mock_service):
        ...
        with patch("src.git_taz.cli.checkout_cli.GitRepository") as mock_repo_class:
            with patch(
                "src.git_taz.cli.checkout_cli.GitOperationsService"
    ...
    def test_checkout_interactive_branches(
        self, mock_input, cli_instance, mock_service, capsys
    ):
    ...
    def test_checkout_interactive_tags(
        self, mock_input, cli_instance, mock_service, capsys
    ):
    ...
    def test_checkout_interactive_invalid_choice(
        self, mock_input, cli_instance, capsys
    ):
    ...
    def test_checkout_interactive_keyboard_interrupt(
        self, mock_input, cli_instance, capsys
    ):
    ...
    )  # Choose branches, then first branch
    def test_checkout_from_list_branches_success(
        self, mock_input, cli_instance, mock_service, capsys
    ):
    ...
    def test_checkout_from_list_quit(
        self, mock_input, cli_instance, mock_service, capsys
    ):
    ...
    def test_checkout_from_list_invalid_selection(
        self, mock_input, cli_instance, mock_service, capsys
    ):
    ...
    def test_checkout_from_list_invalid_input(
        self, mock_input, cli_instance, mock_service, capsys
    ):
    ...
    @patch("builtins.input", side_effect=KeyboardInterrupt())
    def test_checkout_from_list_keyboard_interrupt(
        self, mock_input, cli_instance, capsys
    ):
    ...
    @patch("builtins.input", side_effect=["q"])  # Quit
    def test_checkout_from_list_tags(
        self, mock_input, cli_instance, mock_service, capsys
    ):
